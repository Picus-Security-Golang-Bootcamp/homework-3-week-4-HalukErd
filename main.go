...
import (
	"fmt"
	postgres "github.com/HalukErd/Week4Assignment/common/db"
	"github.com/HalukErd/Week4Assignment/csv"
...
func readFromCsvAndInsertSampleData(authorRepo *author.AuthorRepo, bookRepo *book.BookRepo) {
	bookCsvLines, err := csv.ReadCsvToBookAndAuthor("resources/books.csv")
	if err != nil {
		log.Fatal(err)
	}
